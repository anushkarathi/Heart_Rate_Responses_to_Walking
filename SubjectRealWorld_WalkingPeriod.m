...
figure 
errorbar(stride_speed_mean(59),HRATE_mean(59),HRATE_stdev(59),HRATE_stdev(59),stride_speed_stdev(59),stride_speed_stdev(59),'g','Linewidth',2)
hold on 
errorbar(stride_speed_mean(60),HRATE_mean(60),HRATE_stdev(60),HRATE_stdev(60),stride_speed_stdev(60),stride_speed_stdev(60),'g','Linewidth',2)
hold on 
errorbar(stride_speed_mean(61),HRATE_mean(61),HRATE_stdev(61),HRATE_stdev(61),stride_speed_stdev(61),stride_speed_stdev(60),'g','Linewidth',2)
xlabel('Stride Speed');
ylabel('Heart Rate');
title('s6 city activities');
set(gca, 'FontSize',20, 'Linewidth',1);


figure 
errorbar(stride_speed_mean(2),HRATE_mean(2),HRATE_stdev(2),HRATE_stdev(2),stride_speed_stdev(2),stride_speed_stdev(2),'r','Linewidth',2)
hold on 
errorbar(stride_speed_mean(10),HRATE_mean(10),HRATE_stdev(10),HRATE_stdev(10),stride_speed_stdev(10),stride_speed_stdev(10),'r','Linewidth',2)
hold on 
errorbar(stride_speed_mean(27),HRATE_mean(27),HRATE_stdev(27),HRATE_stdev(27),stride_speed_stdev(27),stride_speed_stdev(27),'r','Linewidth',2)
hold on 
errorbar(stride_speed_mean(31),HRATE_mean(31),HRATE_stdev(31),HRATE_stdev(31),stride_speed_stdev(31),stride_speed_stdev(31),'r','Linewidth',2)
xlabel('Stride Speed');
ylabel('Heart Rate');
title('s6 strolls on North Campus');
set(gca, 'FontSize',20, 'Linewidth',1);
